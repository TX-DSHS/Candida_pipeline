...
echo "Sample_Name	GC_After_Trimming	Average_Q_Score_After_Trimming	Reference_Length_Coverage_After_Trimming	Pass/Fail	QC_Comment" | cat - ${prefix}/$1"_QCREPORT5.temp" | sed 's/%//' > ${prefix}/$1"_QC_REPORT.txt"
#done
